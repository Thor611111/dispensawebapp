...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DispensaAI Dispensa, ricette e pasti intelligenti" },
      { name: "description", content: "Gestisci dispensa, suggerisci ricette, pianifica i pasti e tieni sotto controllo la spesa." },
      { property: "og:title", content: "DispensaAI Dispensa, ricette e pasti intelligenti" },
      ...
      { name: "twitter:title", content: "DispensaAI Dispensa, ricette e pasti intelligenti" },
