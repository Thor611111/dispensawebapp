...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PantryAI — Dispensa, ricette e pasti intelligenti" },
      ...
      { property: "og:description", content: "Assistente alimentare intelligente per dispensa, ricette, pasti e budget." },
