...
Deno.serve(async (req) => {
  ...
  try {
    const { foodItems, preferences, count = 5, likes = [], dislikes = [], filters = {}, slotsPlan = [], recentTitles = [], viewedTitles = [], frequentIngredients = [] } = await req.json();
